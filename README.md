...
## Web Scraping
Used web scraper to scrape 1000 job postings from glassdoor.com. With each job, we got the following:
*	Job title
*	Salary Estimate
*	Job Description
*	Rating
...
*	**Random Forest** : MAE = 13.85
*	**Lasso Regression**: MAE = 20.51
*	**Linear Regression**: MAE = 21.92
